...
> Oh My GitHub adaptation: this file is copied from Memoh's `packages/ui/AGENTS.md`.
> Treat `@memohai/ui` as `@oh-my-github/ui`. The design-language contract is
> intentionally inherited from Memoh.
